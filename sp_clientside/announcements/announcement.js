var AFC = window.AFC || {};
AFC.Notices = (function (win, undefined) {
	var settings = {
		// announcements: {
	...
	cHtmlParts["href-modal"] =
		'<a href="#" onclick="javascript:AFC.Notices.openDialog(\'{0}\');"><span class="fa fa-file-text-o"></span> {1}</a>';
	...
	cHtmlParts["biography"] =
		'<div class="link-item" style="color: #808080; font-size: x-small; padding-bottom:3px; padding-top:3px;" align="right"><a href="#" onclick="javascript:AFC.Notices.openDialog(\'{0}\')"><em>Biography</em></a> </div>';
	cHtmlParts["archive"] =
